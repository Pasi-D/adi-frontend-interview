...
export default async function Cart() {
  ...
  const cartItems: Array<ProductCartItem> = cartCookie ? JSON.parse(cartCookie.value) : [];
  ...
  return (
    <main className="flex min-h-[100svh] w-full flex-col items-center justify-center gap-8 p-8">
      ...
      <h1 className="text-3xl text-gray-900">Cart Page</h1>
      <pre className="text-gray-900">
        {cartItems.length > 0 ? JSON.stringify(cartItems, null, 2) : "[]"}
      </pre>
      <a
